...
export default function TaskActionsItems(menuItemsData: MenuItemsData, taskMenuProps: unknown): MenuProps['items'] {
    ...
    menuItems.push([{
        ...
        label: withCount(t('common.uploadAnnotations'), 'load_task_anno'),
    ...
    menuItems.push([{
        ...
        label: withCount(t('common.exportTaskDataset'), 'export_task_dataset'),
    ...
    if (onOpenBugTracker) {
        menuItems.push([{
            ...
            label: withCount(t('common.openBugTracker'), 'open_bug_tracker'),
    ...
    menuItems.push([{
        ...
        label: withCount(t('common.automaticAnnotation'), 'run_auto_annotation'),
    }, 30]);

    menuItems.push([{
        key: 'backup_task',
        onClick: onBackupTask,
        label: withCount(t('common.backupTask'), 'backup_task'),
    ...
    menuItems.push([{
        key: 'view-analytics',
        label: withCount(t('common.viewAnalytics'), 'view-analytics', `/tasks/${taskId}/analytics`),
        disabled: isDisabled('view-analytics'),
    }, 60]);

    menuItems.push([{
        key: 'quality_control',
        label: withCount(t('common.qualityControl'), 'quality_control', `/tasks/${taskId}/quality-control`),
    ...
    if (isConsensusEnabled) {
        menuItems.push([{
            ...
            label: withCount(t('common.consensusManagement'), 'consensus_management', `/tasks/${taskId}/consensus`),
    ...
    if (onMergeConsensusJobs) {
        menuItems.push([{
            ...
            label: withCount(t('common.mergeConsensusJobs'), 'merge_consensus_jobs'),
    ...
    if (!projectId) {
        menuItems.push([{
            ...
            label: withCount(t('common.moveToProject'), 'move_task_to_project'),
        ...
        menuItems.push([{
            ...
            label: (
                <CVATMenuEditLabel>
                    {withCount(t('common.organization'), 'edit_organization')}
                </CVATMenuEditLabel>
            ),
        }, 100]);
    }
    ...
    menuItems.push([{
        ...
        label: withCount(t('common.delete'), 'delete_task'),

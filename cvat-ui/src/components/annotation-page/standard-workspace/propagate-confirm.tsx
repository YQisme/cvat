...
function PropagateConfirmComponent(): JSX.Element {
    ...
    return (
        <Modal
            okType='primary'
            okText={t('annotation.propagate.yes')}
            ...
            title={t('annotation.propagate.title')}
            open={visible}
            destroyOnClose
        ...
        >
            <div className='cvat-propagate-confirm'>
                <Row>
                    <Col>
                        <Text>{t('annotation.propagate.specifyDirection')}</Text>
                    </Col>
                    <Col offset={1}>
                        <Radio.Group
                            size='small'
                ...
                <Row>
                    <Col>{t('annotation.propagate.howManyCopies')}</Col>
                    <Col offset={1}>
                        <InputNumber
                ...
                <Row className='cvat-propagate-up-to-wrapper'>
                    <Col span={24}>
                        <Text>{t('annotation.propagate.specifyRange')} </Text>
                    </Col>
                    <Col className='cvat-propagate-slider-wrapper' span={12} offset={1}>
                        <Slider
                            ...
                            marks={frameNumber !== targetFrame ? {
                                [frameNumber]: t('annotation.propagate.fromMark'),
                                [targetFrame]: t('annotation.propagate.toMark'),
                            } : undefined}

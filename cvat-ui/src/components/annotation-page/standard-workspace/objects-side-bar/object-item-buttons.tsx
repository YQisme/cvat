...
function NavigatePrevKeyframe(props: Props): JSX.Element {
    ...
    return navigatePrevKeyframe ? (
        <CVATTooltip title={t('annotation.tooltips.prevKeyframe', { shortcut: prevKeyFrameShortcut })}>
...
function NavigateNextKeyframe(props: Props): JSX.Element {
    ...
    return navigateNextKeyframe ? (
        <CVATTooltip title={t('annotation.tooltips.nextKeyframe', { shortcut: nextKeyFrameShortcut })}>
...
function SwitchLock(props: Props): JSX.Element {
    ...
    return (
        <CVATTooltip title={t('annotation.tooltips.switchLock', { shortcut: switchLockShortcut })}>
            {locked ? (
...
function SwitchOccluded(props: Props): JSX.Element {
    ...
    return (
        <CVATTooltip title={t('annotation.tooltips.switchOccluded', { shortcut: switchOccludedShortcut })}>
            {occluded ? (
                <TeamOutlined
...
function SwitchPinned(props: Props): JSX.Element {
    ...
    const style = locked ? disabledStyle : {};
    return (
        <CVATTooltip title={t('annotation.tooltips.switchPinned', { shortcut: switchPinnedShortcut })}>
            {pinned ? (
                <PushpinFilled
...
function SwitchHidden(props: Props): JSX.Element {
    ...
    return (
        <CVATTooltip title={t('annotation.tooltips.switchHidden', { shortcut: switchHiddenShortcut })}>
            {hidden ? (
                <EyeInvisibleFilled
...
function SwitchOutside(props: Props): JSX.Element {
    ...
    return (
        <CVATTooltip title={t('annotation.tooltips.switchOutside', { shortcut: switchOutsideShortcut })}>
            {outside ? (
                <Icon
...
function SwitchKeyframe(props: Props): JSX.Element {
    ...
    return (
        <CVATTooltip title={t('annotation.tooltips.switchKeyframe', { shortcut: switchKeyFrameShortcut })}>
            {keyframe ? (
                <StarFilled
                    style={style}

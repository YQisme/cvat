...
export default function JobActionsItems(
    ...
    menuItems.push([{
        key: MenuKeys.TASK,
        label: withCount(t('common.goToTask'), MenuKeys.TASK, `/tasks/${taskId}`),
    ...
    if (jobsToActWithParents.length && onGoToParent) {
        menuItems.push([{
            ...
            label: withCount(t('common.goToParent'), MenuKeys.GO_TO_PARENT),
    ...
    if (jobsToActWithReplicas.length && onGoToReplicas) {
        menuItems.push([{
            ...
            label: withCount(t('common.goToReplicas'), MenuKeys.GO_TO_REPLICAS),
    ...
    if (projectId) {
        menuItems.push([{
            ...
            label: withCount(t('common.goToProject'), MenuKeys.PROJECT, `/projects/${projectId}`),
    ...
    if (onOpenBugTracker) {
        menuItems.push([{
            ...
            label: withCount(t('common.goToBugTracker'), MenuKeys.BUG_TRACKER),
    ...
    menuItems.push([{
        ...
        label: withCount(t('common.importAnnotations'), MenuKeys.IMPORT_JOB),
    ...
    menuItems.push([{
        ...
        label: withCount(t('common.exportAnnotations'), MenuKeys.EXPORT_JOB),
    ...
    if (onMergeConsensusJob) {
        menuItems.push([{
            ...
            label: withCount(t('common.mergeConsensusJob'), MenuKeys.MERGE_SPECIFIC_CONSENSUS_JOBS),
    ...
    menuItems.push([{
        ...
        label: <CVATMenuEditLabel>{withCount(t('common.assignee'), MenuKeys.EDIT_ASSIGNEE)}</CVATMenuEditLabel>,
    ...
    menuItems.push([{
        ...
        label: <CVATMenuEditLabel>{withCount(t('common.state'), MenuKeys.EDIT_STATE)}</CVATMenuEditLabel>,
    ...
    menuItems.push([{
        ...
        label: <CVATMenuEditLabel>{withCount(t('common.stage'), MenuKeys.EDIT_STAGE)}</CVATMenuEditLabel>,
        disabled: isDisabled(MenuKeys.EDIT_STAGE),
    }, 100]);

    menuItems.push([{
        key: MenuKeys.VIEW_ANALYTICS,
        label: withCount(t('common.viewAnalytics'), MenuKeys.VIEW_ANALYTICS, `/tasks/${taskId}/jobs/${jobId}/analytics`),
    ...
    if (onDeleteJob) {
        ...
        menuItems.push([{
            key: MenuKeys.DELETE,
            onClick: onDeleteJob,
            label: withCount(t('common.delete'), MenuKeys.DELETE),
